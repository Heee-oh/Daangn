package com.daangn.market.common.auth.integration;
...
class AuthSecurityIntegrationTest {
    ...
    void signupAndAccessWithToken() throws Exception {
        ...
        String accessToken = JsonPath.read(signupResult.getResponse().getContentAsString(), "$.access_token");
    ...
    void loginReturnsToken() throws Exception {
        ...
        String accessToken = JsonPath.read(loginResult.getResponse().getContentAsString(), "$.access_token");
        assertThat(accessToken).isNotBlank();
    }
